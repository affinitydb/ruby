...
### <proto file: ../kernel/src/affinity.proto>
# //**************************************************************************************
# //
...
# 		optional uint32		stamp	= 4; // PIN stamp. Only relevant in output streams returned by Affinity.
...
module AffinityPB
  ::Protobuf::OPTIONS[:"java_package"] = "com.affinity"
  ::Protobuf::OPTIONS[:"java_outer_classname"] = "stream"
  class ErrorCode < ::Protobuf::Enum
    defined_in __FILE__
    RC_NOTFOUND = value(:RC_NOTFOUND, 1)
    RC_ALREADYEXISTS = value(:RC_ALREADYEXISTS, 2)
    RC_INTERNAL = value(:RC_INTERNAL, 3)
    RC_NOACCESS = value(:RC_NOACCESS, 4)
    RC_NORESOURCES = value(:RC_NORESOURCES, 5)
    RC_FULL = value(:RC_FULL, 6)
    RC_DEVICEERR = value(:RC_DEVICEERR, 7)
    RC_DATAERROR = value(:RC_DATAERROR, 8)
    RC_EOF = value(:RC_EOF, 9)
    RC_TIMEOUT = value(:RC_TIMEOUT, 10)
    RC_REPEAT = value(:RC_REPEAT, 11)
    RC_CORRUPTED = value(:RC_CORRUPTED, 12)
    RC_CANCELED = value(:RC_CANCELED, 13)
    RC_VERSION = value(:RC_VERSION, 14)
    RC_TRUE = value(:RC_TRUE, 15)
    RC_FALSE = value(:RC_FALSE, 16)
    RC_TYPE = value(:RC_TYPE, 17)
    RC_DIV0 = value(:RC_DIV0, 18)
    RC_INVPARAM = value(:RC_INVPARAM, 19)
    RC_READTX = value(:RC_READTX, 20)
    RC_OTHER = value(:RC_OTHER, 21)
    RC_DEADLOCK = value(:RC_DEADLOCK, 22)
    RC_QUOTA = value(:RC_QUOTA, 23)
    RC_SHUTDOWN = value(:RC_SHUTDOWN, 24)
    RC_DELETED = value(:RC_DELETED, 25)
    RC_CLOSED = value(:RC_CLOSED, 26)
    RC_READONLY = value(:RC_READONLY, 27)
    RC_NOSESSION = value(:RC_NOSESSION, 28)
    RC_INVOP = value(:RC_INVOP, 29)
    RC_SYNTAX = value(:RC_SYNTAX, 30)
  end
  class SpecProp < ::Protobuf::Enum
    defined_in __FILE__
    SP_PINID = value(:SP_PINID, 1)
    SP_DOCUMENT = value(:SP_DOCUMENT, 2)
    SP_PARENT = value(:SP_PARENT, 3)
    SP_VALUE = value(:SP_VALUE, 4)
    SP_CREATED = value(:SP_CREATED, 5)
    SP_CREATEDBY = value(:SP_CREATEDBY, 6)
    SP_UPDATED = value(:SP_UPDATED, 7)
    SP_UPDATEDBY = value(:SP_UPDATEDBY, 8)
    SP_ACL = value(:SP_ACL, 9)
    SP_URI = value(:SP_URI, 10)
    SP_STAMP = value(:SP_STAMP, 11)
    SP_CLASSID = value(:SP_CLASSID, 12)
    SP_PREDICATE = value(:SP_PREDICATE, 13)
    SP_NINSTANCES = value(:SP_NINSTANCES, 14)
    SP_NDINSTANCES = value(:SP_NDINSTANCES, 15)
    SP_SUBCLASSES = value(:SP_SUBCLASSES, 16)
    SP_SUPERCLASSES = value(:SP_SUPERCLASSES, 17)
    SP_CLASS_INFO = value(:SP_CLASS_INFO, 18)
    SP_INDEX_INFO = value(:SP_INDEX_INFO, 19)
    SP_PROPERTIES = value(:SP_PROPERTIES, 20)
    SP_JOIN_TRIGGER = value(:SP_JOIN_TRIGGER, 21)
    SP_UPDATE_TRIGGER = value(:SP_UPDATE_TRIGGER, 22)
    SP_LEAVE_TRIGGER = value(:SP_LEAVE_TRIGGER, 23)
    SP_REFID = value(:SP_REFID, 24)
    SP_KEY = value(:SP_KEY, 25)
    SP_VERSION = value(:SP_VERSION, 26)
    SP_WEIGHT = value(:SP_WEIGHT, 27)
    SP_PROTOTYPE = value(:SP_PROTOTYPE, 28)
    SP_WINDOW = value(:SP_WINDOW, 29)
    SP_MAX = value(:SP_MAX, 255)
  end
  class SpecEID < ::Protobuf::Enum
    defined_in __FILE__
    EID_COLLECTION = value(:EID_COLLECTION, -1)
    EID_LAST_ELEMENT = value(:EID_LAST_ELEMENT, -2)
    EID_FIRST_ELEMENT = value(:EID_FIRST_ELEMENT, -3)
  end
  class OpMode < ::Protobuf::Enum
    defined_in __FILE__
    OM_PURGE = value(:OM_PURGE, 262144)
    OM_CHECK_STAMP = value(:OM_CHECK_STAMP, 2097152)
    OM_PURGE_IDS = value(:OM_PURGE_IDS, 1048576)
    OM_ALL_WORDS = value(:OM_ALL_WORDS, 4194304)
    OM_DELETED = value(:OM_DELETED, 16777216)
    OM_FOR_UPDATE = value(:OM_FOR_UPDATE, 33554432)
  end
  class PINFlags < ::Protobuf::Enum
    defined_in __FILE__
    PF_NO_REPLICATION = value(:PF_NO_REPLICATION, 1073741824)
    PF_NO_INDEX = value(:PF_NO_INDEX, 536870912)
    PF_NOTIFY = value(:PF_NOTIFY, 268435456)
    PF_REPLICATED = value(:PF_REPLICATED, 134217728)
    PF_HIDDEN = value(:PF_HIDDEN, 67108864)
    PF_READONLY = value(:PF_READONLY, 33554432)
    PF_DELETED = value(:PF_DELETED, 16777216)
    PF_CLASS = value(:PF_CLASS, 8388608)
    PF_TRANSFORMED = value(:PF_TRANSFORMED, 4194304)
    PF_PROJECTED = value(:PF_PROJECTED, 2097152)
  end
  class MetaProps < ::Protobuf::Enum
    defined_in __FILE__
    META_PART = value(:META_PART, 128)
    META_NOFTINDEX = value(:META_NOFTINDEX, 128)
    META_EVAL = value(:META_EVAL, 128)
    META_SSTORAGE = value(:META_SSTORAGE, 64)
    META_RACCESS = value(:META_RACCESS, 64)
    META_NONOTIFICATION = value(:META_NONOTIFICATION, 32)
    META_INHERIT = value(:META_INHERIT, 16)
    META_IFEXIST = value(:META_IFEXIST, 8)
    META_IFNOTEXIST = value(:META_IFNOTEXIST, 4)
    META_DERIVED = value(:META_DERIVED, 4)
    META_STOPWORDS = value(:META_STOPWORDS, 2)
  end
  class ACLPermissions < ::Protobuf::Enum
    defined_in __FILE__
    ACLP_READ = value(:ACLP_READ, 1)
    ACLP_WRITE = value(:ACLP_WRITE, 2)
  end
  class ClassFlags < ::Protobuf::Enum
    defined_in __FILE__
    CF_SDELETE = value(:CF_SDELETE, 1)
    CF_VIEW = value(:CF_VIEW, 2)
    CF_CLUSTERED = value(:CF_CLUSTERED, 4)
    CF_INDEXED = value(:CF_INDEXED, 8)
    CF_UNIQUE = value(:CF_UNIQUE, 16)
  end
  class ReturnType < ::Protobuf::Enum
    defined_in __FILE__
    RT_PINS = value(:RT_PINS, 1)
    RT_COUNT = value(:RT_COUNT, 2)
    RT_PIDS = value(:RT_PIDS, 3)
    RT_SRCPINS = value(:RT_SRCPINS, 4)
    RT_VALUES = value(:RT_VALUES, 5)
  end
  class PID < ::Protobuf::Message
    defined_in __FILE__
    optional :uint64, :id, 1
    optional :uint32, :ident, 2
  end
  class Ref < ::Protobuf::Message
    defined_in __FILE__
    required :PID, :id, 1
    required :uint32, :property, 2
    optional :uint32, :eid, 3
    optional :uint32, :vid, 4
  end
  class Value < ::Protobuf::Message
    defined_in __FILE__
    class ValueType < ::Protobuf::Enum
      defined_in __FILE__
      VT_ANY = value(:VT_ANY, 0)
      VT_INT = value(:VT_INT, 1)
      VT_UINT = value(:VT_UINT, 2)
      VT_INT64 = value(:VT_INT64, 3)
      VT_UINT64 = value(:VT_UINT64, 4)
      VT_RESERVED2 = value(:VT_RESERVED2, 5)
      VT_FLOAT = value(:VT_FLOAT, 6)
      VT_DOUBLE = value(:VT_DOUBLE, 7)
      VT_BOOL = value(:VT_BOOL, 8)
      VT_DATETIME = value(:VT_DATETIME, 9)
      VT_INTERVAL = value(:VT_INTERVAL, 10)
      VT_URIID = value(:VT_URIID, 11)
      VT_IDENTITY = value(:VT_IDENTITY, 12)
      VT_STRING = value(:VT_STRING, 13)
      VT_BSTR = value(:VT_BSTR, 14)
      VT_URL = value(:VT_URL, 15)
      VT_RESERVED1 = value(:VT_RESERVED1, 16)
      VT_REFID = value(:VT_REFID, 18)
      VT_REFIDPROP = value(:VT_REFIDPROP, 20)
      VT_REFIDELT = value(:VT_REFIDELT, 22)
      VT_EXPR = value(:VT_EXPR, 23)
      VT_QUERY = value(:VT_QUERY, 24)
      VT_ARRAY = value(:VT_ARRAY, 25)
      VT_STRUCT = value(:VT_STRUCT, 27)
      VT_RANGE = value(:VT_RANGE, 28)
      VT_CURRENT = value(:VT_CURRENT, 30)
    end
    class ModOp < ::Protobuf::Enum
      defined_in __FILE__
      OP_SET = value(:OP_SET, 0)
      OP_ADD = value(:OP_ADD, 1)
      OP_ADD_BEFORE = value(:OP_ADD_BEFORE, 2)
      OP_MOVE = value(:OP_MOVE, 3)
      OP_MOVE_BEFORE = value(:OP_MOVE_BEFORE, 4)
      OP_DELETE = value(:OP_DELETE, 5)
      OP_EDIT = value(:OP_EDIT, 6)
      OP_RENAME = value(:OP_RENAME, 7)
      OP_PLUS = value(:OP_PLUS, 8)
      OP_MINUS = value(:OP_MINUS, 9)
      OP_MUL = value(:OP_MUL, 10)
      OP_DIV = value(:OP_DIV, 11)
      OP_MOD = value(:OP_MOD, 12)
      OP_NEG = value(:OP_NEG, 13)
      OP_NOT = value(:OP_NOT, 14)
      OP_AND = value(:OP_AND, 15)
      OP_OR = value(:OP_OR, 16)
      OP_XOR = value(:OP_XOR, 17)
      OP_LSHIFT = value(:OP_LSHIFT, 18)
      OP_RSHIFT = value(:OP_RSHIFT, 19)
      OP_MIN = value(:OP_MIN, 20)
      OP_MAX = value(:OP_MAX, 21)
      OP_ABS = value(:OP_ABS, 22)
      OP_LN = value(:OP_LN, 23)
      OP_EXP = value(:OP_EXP, 24)
      OP_POW = value(:OP_POW, 25)
      OP_SQRT = value(:OP_SQRT, 26)
      OP_FLOOR = value(:OP_FLOOR, 27)
      OP_CEIL = value(:OP_CEIL, 28)
      OP_CONCAT = value(:OP_CONCAT, 29)
      OP_LOWER = value(:OP_LOWER, 30)
      OP_UPPER = value(:OP_UPPER, 31)
      OP_TONUM = value(:OP_TONUM, 32)
      OP_TOINUM = value(:OP_TOINUM, 33)
      OP_CAST = value(:OP_CAST, 34)
    end
    class StrEdit < ::Protobuf::Message
      defined_in __FILE__
      optional :string, :str, 1
      optional :bytes, :bstr, 2
      required :uint32, :length, 3
      optional :uint64, :offset, 4
    end
    class VArray < ::Protobuf::Message
      defined_in __FILE__
      optional :uint32, :l, 1
      repeated :Value, :v, 2
    end
    ...
    optional :bytes, :bstr, 4
    optional :sint32, :i, 5
    optional :uint32, :ui, 6
    optional :sint64, :i64, 7
    optional :uint64, :ui64, 8
    optional :float, :f, 9
    optional :double, :d, 10
    optional :fixed64, :datetime, 11
    optional :sfixed64, :interval, 12
    optional :PID, :id, 13
    optional :VArray, :varray, 14
    optional :Ref, :ref, 15
    optional :bool, :b, 16
    optional :ModOp, :op, 17, :default => :OP_SET
    optional :uint32, :eid, 18, :default => 4294967295
    optional :uint32, :meta, 19
    optional :StrEdit, :edit, 20
    optional :uint32, :units, 21
    optional :uint64, :cid, 128
  end
  class AfyStream < ::Protobuf::Message
    defined_in __FILE__
    class MODOP < ::Protobuf::Enum
      defined_in __FILE__
      OP_INSERT = value(:OP_INSERT, 0)
      OP_UPDATE = value(:OP_UPDATE, 1)
      OP_DELETE = value(:OP_DELETE, 2)
      OP_COPY = value(:OP_COPY, 3)
      OP_UNDELETE = value(:OP_UNDELETE, 4)
    end
    class TXOP < ::Protobuf::Enum
      defined_in __FILE__
      TX_START = value(:TX_START, 1)
      TX_COMMIT = value(:TX_COMMIT, 2)
      TX_COMMIT_ALL = value(:TX_COMMIT_ALL, 3)
      TX_ROLLBACK = value(:TX_ROLLBACK, 4)
      TX_ROLLBACK_ALL = value(:TX_ROLLBACK_ALL, 5)
      TX_START_READONLY = value(:TX_START_READONLY, 6)
      TX_START_CLASSMODIFY = value(:TX_START_CLASSMODIFY, 7)
    end
    class StringMap < ::Protobuf::Message
      defined_in __FILE__
      required :string, :str, 1
      required :uint32, :id, 2
    end
    class Result < ::Protobuf::Message
      defined_in __FILE__
    ...
    class PathSQL < ::Protobuf::Message
      defined_in __FILE__
      required :string, :sq, 1
      optional :uint64, :cid, 2
      optional :ReturnType, :rtt, 3
      repeated :uint32, :uids, 4
      repeated :Value, :params, 5
      optional :uint32, :limit, 6
      optional :uint32, :offset, 7
      optional :uint32, :mode, 8
      optional :bool, :abortOnError, 9
    end
    class PIN < ::Protobuf::Message
      defined_in __FILE__
      optional :MODOP, :op, 1
      optional :PID, :id, 2
      optional :uint32, :mode, 3
      optional :uint32, :stamp, 4
      optional :uint32, :nValues, 5
      repeated :Value, :values, 6
      optional :uint64, :cid, 7
      optional :ReturnType, :rtt, 8
    end
    class Compound < ::Protobuf::Message
      defined_in __FILE__
      optional :uint32, :nPINs, 1
      repeated :PIN, :pins, 2
    ...
    class ReservedPages < ::Protobuf::Message
      defined_in __FILE__
      repeated :uint32, :pageID, 1
    end
    optional :StringMap, :owner, 1
    optional :uint32, :storeID, 2
    repeated :PIN, :pins, 3
    repeated :StringMap, :properties, 4
    repeated :StringMap, :identities, 5
    repeated :PathSQL, :stmt, 6
    repeated :TXOP, :txop, 7
    repeated :Result, :result, 8
    repeated :Compound, :compound, 9
    repeated :Status, :status, 10
    repeated :uint32, :flush, 11
    repeated :ReservedPages, :resPages, 12
